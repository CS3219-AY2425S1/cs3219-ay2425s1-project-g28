...
export const ADD_TEST_CASE_FILES_TOOLTIP_MESSAGE = `Upload files for executing test cases when the user submits code. <br /><br /> This is a required field. Only text files are accepted. <br /><br /> Please ensure that each test case in the file is separated by a double newline. <br /><br />For example, if you want to find the sum of four input numbers, an input file with 2 test cases could look like:<br />"""<br />1<br />2<br />3<br />4<br /><br />5<br />6<br />7<br />8<br />"""<br /><br />The corresponding output file, with each result in a single line, should look like:<br />"""<br />10<br /><br />26<br />"""<br /><br />Each output line is the sum of the four numbers in the respective test case.`;
