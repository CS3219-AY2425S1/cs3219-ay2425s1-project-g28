export const QN_HIST_CREATED_MESSAGE = "Question history created successfully.";
...
export const MONGO_OBJ_ID_MALFORMED_MESSAGE =
  "The question history ID is not valid";
